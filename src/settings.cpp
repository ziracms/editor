...
Settings::Settings(QObject * parent) : QObject(parent)
{
    data = {
        ...
        {"shortcut_help", "F1"},
        {"shortcut_sidebar", "Ctrl+Alt+S"},
        {"shortcut_toolbar", "Ctrl+Alt+B"},
        {"shortcut_output", "Ctrl+Alt+O"},
        {"shortcut_quick_access", "Ctrl+Alt+Up"},
        {"shortcut_quick_access_alt", "Ctrl+P"},
        {"shortcut_duplicate_line", "Ctrl+D"},
        {"shortcut_delete_line", "Ctrl+Alt+D"},
        {"shortcut_filebrowser", "Ctrl+Alt+F"},
        {"shortcut_open_file", "Ctrl+O"},
        {"shortcut_open_project", "Ctrl+Shift+O"},
        {"shortcut_new_file", "Ctrl+N"},
        {"shortcut_new_folder", "Ctrl+Shift+N"},
        {"shortcut_previous_tab", "Ctrl+Alt+Left"},
        {"shortcut_next_tab", "Ctrl+Alt+Right"},
        {"shortcut_tabs_list", "Ctrl+Alt+Down"},
