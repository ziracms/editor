...
static void qBrushSetAlphaF(QBrush *brush, qreal alpha)
{
    if (const QGradient *gradient = brush->gradient()) {
        ...
        default:
            qWarning("QPlastiqueStyleDark::qBrushLight() - unknown gradient type"
...
static QBrush qBrushDark(QBrush brush, int dark)
{
    if (const QGradient *gradient = brush.gradient()) {
        ...
        default:
            qWarning("QPlastiqueStyleDark::qBrushDark() - unknown gradient type"
                     " - falling back to QLinearGradient");
        case QGradient::LinearGradient: {
            QLinearGradient grad = *static_cast<const QLinearGradient *>(gradient);
            grad.setStops(stops);
...
/*!
    \class QPlastiqueStyleDark
    \brief The QPlastiqueStyleDark class provides a widget style similar to the
...
/*!
    Constructs a QPlastiqueStyleDark object.
*/
QPlastiqueStyleDark::QPlastiqueStyleDark()
    : QProxyStyle(QStyleFactory::create(QLatin1String("Windows"))), animateStep(0), progressBarAnimateTimer(0)
{
    setObjectName(QLatin1String("PlastiqueDark"));
}

/*!
    Destructs the QPlastiqueStyleDark object.
*/
QPlastiqueStyleDark::~QPlastiqueStyleDark()
{
}
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::drawPrimitive(PrimitiveElement element, const QStyleOption *option,
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::drawControl(ControlElement element, const QStyleOption *option,
                                  QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.background().color().darker(178);
    QColor alphaCornerColor;
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::drawComplexControl(ComplexControl control, const QStyleOptionComplex *option,
                                         QPainter *painter, const QWidget *widget) const
{
    QColor borderColor = option->palette.background().color().darker(178);
    QColor alphaCornerColor;
...
/*!
  \reimp
*/
QSize QPlastiqueStyleDark::sizeFromContents(ContentsType type, const QStyleOption *option,
...
/*!
  \reimp
*/
QRect QPlastiqueStyleDark::subElementRect(SubElement element, const QStyleOption *option, const QWidget *widget) const
{
    QRect rect;
    switch (element) {
...
/*!
  \reimp
*/
QRect QPlastiqueStyleDark::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int QPlastiqueStyleDark::styleHint(StyleHint hint, const QStyleOption *option, const QWidget *widget,
...
/*!
  \reimp
*/
QStyle::SubControl QPlastiqueStyleDark::hitTestComplexControl(ComplexControl control, const QStyleOptionComplex *option,
...
/*!
  \reimp
*/
int QPlastiqueStyleDark::pixelMetric(PixelMetric metric, const QStyleOption *option, const QWidget *widget) const
{
    int ret = -1;
    switch (metric) {
    case PM_MenuVMargin:
...
/*!
  \reimp
*/
QPalette QPlastiqueStyleDark::standardPalette() const
{
    QPalette palette;

    QColor base_color = QColor("#17181b");
    QColor text_color = QColor("#f1f1f1");
    QColor bg_color = QColor("#17181b");
    ...
    QColor backdrop_fg_color = QColor("#999999");
    QColor backdrop_base_color = QColor("#17181b");
    QColor backdrop_selected_fg_color = QColor("#555555");
    ...
    QColor insensitive_bg_color = QColor("#17181b");
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::polish(QWidget *widget)
{
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::unpolish(QWidget *widget)
{
    if (qobject_cast<QPushButton *>(widget)
#ifndef QT_NO_COMBOBOX
        || qobject_cast<QComboBox *>(widget)
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::polish(QApplication *app)
{
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::polish(QPalette &pal)
{
...
/*!
  \reimp
*/
void QPlastiqueStyleDark::unpolish(QApplication *app)
{
...
/*!
    \reimp
*/
QIcon QPlastiqueStyleDark::standardIcon(StandardPixmap standardIcon, const QStyleOption *option,
...
/*!
    \reimp
*/
QPixmap QPlastiqueStyleDark::standardPixmap(StandardPixmap standardPixmap, const QStyleOption *opt,
                                        const QWidget *widget) const
{
...
/*!
    \reimp
*/
int QPlastiqueStyleDark::layoutSpacing(QSizePolicy::ControlType control1,
...
/*!
    \reimp
*/
bool QPlastiqueStyleDark::eventFilter(QObject *watched, QEvent *event)
{
#ifndef QT_NO_PROGRESSBAR
    switch (event->type()) {
...
/*!
    \reimp
*/
bool QPlastiqueStyleDark::event(QEvent *event)
{
    switch (event->type()) {
    case QEvent::Timer: {
#ifndef QT_NO_PROGRESSBAR
...
void QPlastiqueStyleDark::startProgressAnimation(QProgressBar *bar)
{
...
void QPlastiqueStyleDark::stopProgressAnimation(QProgressBar *bar)
{
    if (!bars.isEmpty()) {
        bars.removeOne(bar);
